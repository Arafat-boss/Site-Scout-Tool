        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <span className="absolute -top-1 -right-1 flex h-2.5 w-2.5">
              ...
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-zinc-900 dark:bg-white"></span>
            </span>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-0.5">
              Querying Google Search & Maps for <strong className="text-zinc-900 dark:text-zinc-200">{niche}</strong>, analyzing source code for Wix & Squarespace signatures...
            </p>
          </div>
        </div>
